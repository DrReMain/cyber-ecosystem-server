...
func DeleteDepartmentOneHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := department.NewDeleteDepartmentOneLogic(r.Context(), svcCtx)
		resp, err := l.DeleteDepartmentOne(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
