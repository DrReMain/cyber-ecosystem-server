...
type DeleteRoleOneLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewDeleteRoleOneLogic(ctx context.Context, svcCtx *svc.ServiceContext) *DeleteRoleOneLogic {
	return &DeleteRoleOneLogic{
...
func (l *DeleteRoleOneLogic) DeleteRoleOne(req *types.RoleDeleteReq) (resp *types.RoleDeleteRes, err error) {
	...
	data, err := l.svcCtx.RPCAdminSystem.ROLE.DeleteRole(l.ctx, &admin_system.IDsReq{Ids: []string{*req.ID}})
	if err != nil {
		return nil, errorc.NewGRPCError(err)
	}
