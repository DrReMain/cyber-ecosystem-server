...
func (_q *PositionQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *PositionQuery) FirstIDX(ctx context.Context) string {
...
func (_q *PositionQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *PositionQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *PositionQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *PositionQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PositionQuery) loadUsers(ctx context.Context, query *UserQuery, nodes []*Position, init func(*Position), assign func(*Position, *User)) error {
	...
	nids := make(map[string]map[*Position]struct{})
